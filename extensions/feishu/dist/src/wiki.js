        ...
        async execute(_toolCallId, params) {
            ...
            try {
                ...
                switch (p.action) {
                    ...
                    case "create":
                        return json(await createNode(client, p.space_id, p.title, p.obj_type, p.parent_node_token));
                    case "move":
                        return json(await moveNode(client, p.space_id, p.node_token, p.target_space_id, p.target_parent_token));
                    case "rename":
