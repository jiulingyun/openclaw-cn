...
export const FeishuCalendarSchema = Type.Object({
    ...
    calendar_id: Type.Optional(Type.String({
        description: "[create_event/get_event/update_event/delete_event/list_events/add_attendees] 日历 ID。使用 primary action 获取主日历 ID",
    })),
    ...
    start_time: Type.Optional(Type.String({
        description: "[create_event/update_event/list_events/freebusy] 开始时间 (ISO 8601 或 Unix 秒级时间戳)",
    })),
    end_time: Type.Optional(Type.String({
        description: "[create_event/update_event/list_events/freebusy] 结束时间 (ISO 8601 或 Unix 秒级时间戳)",
    })),
    ...
    event_id: Type.Optional(Type.String({ description: "[get_event/update_event/delete_event/add_attendees] 日程 ID" })),
