...
- Webhook requests are authenticated by comparing `guid`/`password` query params or headers against `channels.bluebubbles.password`. Authentication is always required regardless of loopback/proxy topology.
